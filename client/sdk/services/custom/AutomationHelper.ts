 ...
 */
@Injectable()
export class AutomationHelperApi extends BaseLoopBackApi {
   ...
   */
  public triggerAutomation(automationCommand: any = {}, customHeaders?: Function): Observable<any> {
   ...
   *  - `result` – `{object}` - 
   */
  public retrieveAutomationResult(transactionId: any = {}, waitUntil: any = {}, customHeaders?: Function): Observable<any> {
    ...
    if (typeof waitUntil !== 'undefined' && waitUntil !== null) _urlParams.waitUntil = waitUntil;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
   ...
   *  - `result` – `{string}` - 
   */
  public triggerIntentWhenDone(botCommand: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
